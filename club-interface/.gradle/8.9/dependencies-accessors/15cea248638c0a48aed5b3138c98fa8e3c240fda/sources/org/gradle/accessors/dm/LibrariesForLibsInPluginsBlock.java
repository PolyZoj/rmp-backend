...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final Auth0LibraryAccessors laccForAuth0LibraryAccessors = new Auth0LibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>auth0</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Auth0LibraryAccessors getAuth0() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAuth0LibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class Auth0LibraryAccessors extends SubDependencyFactory {
        private final Auth0JavaLibraryAccessors laccForAuth0JavaLibraryAccessors = new Auth0JavaLibraryAccessors(owner);

        public Auth0LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>auth0.java</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Auth0JavaLibraryAccessors getJava() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAuth0JavaLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Auth0JavaLibraryAccessors extends SubDependencyFactory {

        public Auth0JavaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>jwt</b> with <b>com.auth0:java-jwt</b> coordinates and
         * with version reference <b>java.jwt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>koin.logger</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class KoinLoggerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>slf4j</b> with <b>io.insert-koin:koin-logger-slf4j</b> coordinates and
         * with version reference <b>koin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class KtorServerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>resources</b> with <b>io.ktor:ktor-server-resources-jvm</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class KtorServerCallLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>logging</b> with <b>io.ktor:ktor-server-call-logging-jvm</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>flyway</b> with value <b>10.8.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
